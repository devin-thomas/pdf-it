...
- Compact light/dark switch with native color-scheme metadata and a Dark Reader lock signal.
- Source text area with a live 30,000-character editor limit plus mixed-file uploads up to 10 MB each.
- Optional YouTube and creative-direction controls can stay collapsed for a faster first-run flow.
